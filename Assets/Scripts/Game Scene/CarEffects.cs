...
namespace XGStudios.GameScene
{
    public class CarEffects : MonoBehaviour
    {
        ...
        {
            if (playerObject == null) playerObject = GetComponentInChildren<CarController>();
            return playerObject;
        }

        public CarWheels[] getWheels()
        {
            if (wheels == null) wheels = playerObject.GetComponentsInChildren<CarWheels>();
            return wheels;
        }
    }
}
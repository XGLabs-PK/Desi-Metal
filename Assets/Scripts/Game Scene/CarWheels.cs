...
namespace XGStudios.GameScene
{
    public class CarWheels : MonoBehaviour
    {
        ...
        private CarCollider internalCollider;
        ...
        private CarController parentPlayer;
        ...
        public void initialize(CarController parent)
        {
            parentPlayer = parent;
            ...
            internalCollider = axleObject.AddComponent<CarCollider>();
        ...
        public CarController getParentPlayer()
        {
            return parentPlayer;
        }

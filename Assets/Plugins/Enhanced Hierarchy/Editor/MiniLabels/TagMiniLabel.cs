...
namespace EnhancedHierarchy
{
    public class TagMiniLabel : MiniLabelProvider
    {
        ...
        {
            content.text = EnhancedHierarchy.HasTag ? EnhancedHierarchy.GameObjectTag : string.Empty;
        }
        ...
        public override bool Draw(Rect rect, GUIContent content, GUIStyle style)
        {
            ...
            string tag = EditorGUI.TagField(rect, EnhancedHierarchy.GameObjectTag, style);

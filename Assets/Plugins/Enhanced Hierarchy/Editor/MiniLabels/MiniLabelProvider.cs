...
namespace EnhancedHierarchy
{
    public abstract class MiniLabelProvider
    {
        ...
        {
            Vector2 calculated = Styles.miniLabelStyle.CalcSize(content);
            return calculated.x;
        }
        ...
        public void Draw(ref Rect rect)
        {
            ...
            Color color = EnhancedHierarchy.CurrentColor;
            float alpha = Faded() ? Styles.backgroundColorDisabled.a : Styles.backgroundColorEnabled.a;
            Color finalColor = color * new Color(1f, 1f, 1f, alpha);

...
namespace EnhancedHierarchy
{
    ...
    public static class Styles
    {
        static Styles()
        {
            ...
            Texture2D offTexture = Utility.FindOrLoad(lockOff);
            Texture2D onTexture = Utility.FindOrLoad(lockOn);
        ...
        const string monobehaviourIcon =

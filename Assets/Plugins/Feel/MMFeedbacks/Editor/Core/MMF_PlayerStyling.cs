...
namespace MoreMountains.Feedbacks
{
    ...
    public static class MMF_PlayerStyling
    {
        ...
        static GUIStyle _timingStyle = new GUIStyle();

        static Rect _backgroundRect;
        static Rect _progressRect;
        static Rect _timingRect;
        static Rect _reorderRect;
        static Rect _labelRect;
        static Rect _foldoutRect;
        static Rect _toggleRect;
        static Rect _directionRect;
        static Rect _setupRect;
        static Texture2D _menuIcon;
        static Rect _menuRect;
        static Rect _workRect;
        static Rect _colorRect;
        static Rect _genericMenuRect;
        static Color _headerBackgroundColor;
        static Color _barColor;
        static GUIContent _directionUpIcon;
        static GUIStyle _targetLabelStyle;
        static GUIContent _directionDownIcon;
        public static GUIContent _setupRequiredIcon;
        static GenericMenu _genericMenu;

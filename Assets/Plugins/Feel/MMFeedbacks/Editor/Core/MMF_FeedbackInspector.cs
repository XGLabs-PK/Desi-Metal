...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_FeedbackInspector
    {
        ...
        bool _hasMMHiddenProperties = false;
        ...
        const string _channelFieldName = "Channel";
        ...
        bool DrawCustomInspectors(SerializedProperty currentProperty, MMF_Feedback feedback)
        {
        ...
        bool EqualContents(SerializedProperty a, SerializedProperty b)
        {

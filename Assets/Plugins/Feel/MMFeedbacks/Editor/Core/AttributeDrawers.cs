...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFEnumConditionAttributeDrawer : PropertyDrawer
    {
        ...
        bool GetConditionAttributeResult(MMFEnumConditionAttribute enumConditionAttribute, SerializedProperty property)
        {
            bool enabled = true;
    ...
    public class MMFConditionAttributeDrawer : PropertyDrawer
    {
        ...
        bool GetConditionAttributeResult(MMFConditionAttribute condHAtt, SerializedProperty property)
        {
            bool enabled = true;
            string propertyPath = property.propertyPath;
    ...
    public class MMFInformationAttributeDrawer : PropertyDrawer
    {
        ...
        MMFInformationAttribute informationAttribute => (MMFInformationAttribute)attribute;

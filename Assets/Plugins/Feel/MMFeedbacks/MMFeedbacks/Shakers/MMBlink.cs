            ...
            switch (Method)
            {
                case Methods.MaterialAlpha:
                    ...
                    _initialColor = UseMaterialPropertyBlocks
                        ? TargetRenderer.sharedMaterial.GetColor(_propertyID)
                        : TargetRenderer.material.GetColor(_propertyID);
                ...
                case Methods.ShaderFloatValue:
                    ...
                    _initialShaderFloatValue = UseMaterialPropertyBlocks
                        ? TargetRenderer.sharedMaterial.GetFloat(_propertyID)
                        : TargetRenderer.material.GetFloat(_propertyID);

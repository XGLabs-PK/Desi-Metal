...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMWiggle : MonoBehaviour
    {
        ...
        public virtual void Initialization()
        {
            ...
            _positionInternalProperties.startValue = transform.localPosition;

            _rotationInternalProperties.initialValue = transform.localEulerAngles;
            _rotationInternalProperties.startValue = transform.localEulerAngles;

            _scaleInternalProperties.initialValue = transform.localScale;
            _scaleInternalProperties.startValue = transform.localScale;
            ...
            WiggleProperties properties)
        {
            ...
            if (internalProperties.timeSinceLastPause < internalProperties.pauseDuration)
            {
                ...
                EvaluateCurve(properties.Curve, curveProgress, internalProperties.remapZero,
                    internalProperties.remapOne, ref internalProperties.newValue);
                ...
                case WiggleTypes.PingPong:
                    ...
                    else
                    {
                        newValue = newValue == properties.AmplitudeMin
                            ? properties.AmplitudeMax
                            : properties.AmplitudeMin;

                        startValue = newValue == properties.AmplitudeMin
                            ? properties.AmplitudeMax
                            : properties.AmplitudeMin;
                    }

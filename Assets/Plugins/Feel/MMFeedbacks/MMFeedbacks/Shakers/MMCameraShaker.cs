...
namespace MoreMountains.Feedbacks
{
    ...
    public struct MMCameraZoomEvent
    {
        ...
        public static void Trigger(MMCameraZoomModes mode, float newFieldOfView, float transitionDuration,
            float duration, int channel, bool useUnscaledTime = false, bool stop = false, bool relative = false)
        {
            OnEvent?.Invoke(mode, newFieldOfView, transitionDuration, duration, channel, useUnscaledTime, stop,
                relative);
        }
    }
    ...
    public struct MMCameraShakeEvent
    {
        public delegate void Delegate(float duration, float amplitude, float frequency, float amplitudeX,
            float amplitudeY, float amplitudeZ, bool infinite = false, int channel = 0, bool useUnscaledTime = false);
        ...
        public static void Trigger(float duration, float amplitude, float frequency, float amplitudeX, float amplitudeY,

...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Rotation : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => AnimateRotationTarget != null ? AnimateRotationTarget.name : "";
        ...
        {
            get => ApplyTimeMultiplier(AnimateRotationDuration);
            ...
            if (Active || Owner.AutoPlayOnEnable)
            {
                if (Mode == Modes.Absolute || Mode == Modes.Additive)
                {
                    ...
                    _coroutine = Owner.StartCoroutine(AnimateRotation(AnimateRotationTarget, Vector3.zero,
                        FeedbackDuration, AnimateRotationX, AnimateRotationY, AnimateRotationZ,

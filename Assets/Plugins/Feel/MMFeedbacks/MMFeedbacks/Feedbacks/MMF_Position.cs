...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Position : MMF_Feedback
    {
        ...
        public AnimationCurve AnimatePositionCurveX = new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f),
        ...
        public AnimationCurve AnimatePositionCurveY = new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f),
            new Keyframe(0.6f, -1f), new Keyframe(1, 0f));
        ...
        public AnimationCurve AnimatePositionCurveZ = new AnimationCurve(new Keyframe(0, 0), new Keyframe(0.3f, 1f),
            new Keyframe(0.6f, -1f), new Keyframe(1, 0f));
            ...
            float intensityMultiplier)
        {
            ...
            newValueX = MMFeedbacksHelpers.Remap(newValueX, 0f, 1f, _remapCurveZero * intensityMultiplier,
                _remapCurveOne * intensityMultiplier);

            newValueY = MMFeedbacksHelpers.Remap(newValueY, 0f, 1f, _remapCurveZero * intensityMultiplier,
                _remapCurveOne * intensityMultiplier);

            newValueZ = MMFeedbacksHelpers.Remap(newValueZ, 0f, 1f, _remapCurveZero * intensityMultiplier,
                _remapCurveOne * intensityMultiplier);

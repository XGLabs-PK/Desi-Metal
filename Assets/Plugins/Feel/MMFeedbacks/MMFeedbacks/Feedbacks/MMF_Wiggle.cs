...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_Wiggle : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => TargetWiggle != null ? TargetWiggle.name : "";
        ...
        {
            get => Mathf.Max(ApplyTimeMultiplier(WigglePositionDuration), ApplyTimeMultiplier(WiggleRotationDuration),

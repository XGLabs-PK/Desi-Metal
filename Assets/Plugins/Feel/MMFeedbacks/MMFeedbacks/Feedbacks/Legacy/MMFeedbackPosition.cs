            ...
            if (isActiveAndEnabled || _hostMMFeedbacks.AutoPlayOnEnable)
            {
                ...
                switch (Mode)
                {
                    ...
                    case Modes.AtoB:
                        ...
                        _coroutine = StartCoroutine(MoveFromTo(AnimatePositionTarget, InitialPosition,
                    ...
                    case Modes.AlongCurve:
                        ...
                        _coroutine = StartCoroutine(MoveAlongCurve(AnimatePositionTarget, InitialPosition,

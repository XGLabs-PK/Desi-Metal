    ...
    public class MMFeedbackInstantiateObject : MMFeedback
    {
        ...
        protected override void CustomInitialization(GameObject owner)
        {
            ...
            if (Active && CreateObjectPool && !_poolCreatedOrFound)
            {
                ...
                objectPoolGo.name = name + "_ObjectPooler";
                ...
                _objectPooler.transform.SetParent(transform);
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            {
                _newGameObject = Instantiate(GameObjectToInstantiate) as GameObject;

                if (_newGameObject != null)
                {
                    SceneManager.MoveGameObjectToScene(_newGameObject, gameObject.scene);
                    PositionObject(position);
                }
            }
        }

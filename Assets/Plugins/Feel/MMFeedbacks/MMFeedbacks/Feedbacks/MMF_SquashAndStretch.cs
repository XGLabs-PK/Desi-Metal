...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_SquashAndStretch : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => SquashAndStretchTarget != null ? SquashAndStretchTarget.name : "";
        ...
        {
            get => ApplyTimeMultiplier(AnimateScaleDuration);
            ...
            if (Active || Owner.AutoPlayOnEnable)
            {
                if (Mode == Modes.Absolute || Mode == Modes.Additive)
                {
                    ...
                    _coroutine = Owner.StartCoroutine(AnimateScale(SquashAndStretchTarget, FeedbackDuration,
                        AnimateCurve, Axis, RemapCurveZero * intensityMultiplier, RemapCurveOne * intensityMultiplier));
                }

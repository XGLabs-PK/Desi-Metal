...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_ParticlesInstantiation : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => ParticlesPrefab != null ? ParticlesPrefab.name : "";
        ...
        protected virtual void InstantiateParticleSystem()
        {
            ...
            if (RandomParticlePrefabs.Count > 0)
            {
                if (Mode == Modes.Cached)
                {
                    ...
                    {
                        ParticleSystem newSystem = Object.Instantiate(system, newParent) as ParticleSystem;
                ...
                else
                {
                    ...
                    _instantiatedParticleSystem =
                        Object.Instantiate(RandomParticlePrefabs[random], newParent) as ParticleSystem;
            ...
            {
                _instantiatedParticleSystem = Object.Instantiate(ParticlesPrefab, newParent) as ParticleSystem;

...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMF_NVClip : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => Clip != null ? Clip.name : "";
        public override string RequiresSetupText =>
            "This feedback requires that a Clip be set to be able to work properly. You can set one below.";
#endif

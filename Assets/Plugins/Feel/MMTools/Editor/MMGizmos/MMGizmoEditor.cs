...
namespace MoreMountains.Tools
{
    ...
    public class MMGizmoEditor : Editor
    {
        ...
        static void DrawGizmoSelected(MMGizmo mmGizmo, GizmoType gizmoType)
        {
        ...
        static void DrawGizmoNonSelected(MMGizmo mmGizmo, GizmoType gizmoType)
        {
            if (!mmGizmo.DisplayGizmo)
                return;
        ...
        /// </summary>
        /// <param name="mmGizmo"></param>
        static void DrawGizmos(MMGizmo mmGizmo)
        {
        ...
        /// <returns></returns>
        static bool TestDistance(MMGizmo mmGizmo, float viewDistance)
        {
        ...
        /// </summary>
        /// <param name="mmGizmo"></param>
        static void Initialization(MMGizmo mmGizmo)
        {
        ...
        /// </summary>
        /// <param name="mmGizmo"></param>
        static void DrawColliderGizmo(MMGizmo mmGizmo)
        {
        ...
        /// </summary>
        /// <param name="mmGizmo"></param>
        static void DrawPositionGizmo(MMGizmo mmGizmo)
        {
        ...
        /// </summary>
        /// <param name="mmGizmo"></param>
        static void DrawText(MMGizmo mmGizmo)
        {
        ...
        /// <returns></returns>
        static Vector3 ComputeGizmoPosition(MMGizmo mmGizmo, Vector3 position, bool relativeLock = true)
        {

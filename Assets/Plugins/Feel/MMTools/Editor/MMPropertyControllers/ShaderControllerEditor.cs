...
namespace MoreMountains.Tools
{
    ...
    public class ShaderControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                "m_Script", "Curve", "MinValue", "MaxValue", "Duration", "PingPongPauseDuration",
                "Amplitude", "Frequency", "Shift", "OneTimeDuration", "OneTimeAmplitude", "OneTimeRemapMin",
                "OneTimeRemapMax", "OneTimeCurve", "DisableAfterOneTime", "DisableGameObjectAfterOneTime",
                "OneTimeButton", "AudioAnalyzer",
                ...
                "DrivenLevel", "FromColor", "ToColor",
                "LoopCurve", "LoopStartValue", "LoopEndValue", "LoopDuration", "LoopPauseDuration",
                "InitialValue", "CurrentValue", "CurrentValueNormalized", "InitialColor", "PropertyID", "PropertyFound",
                "TargetMaterial"
            });

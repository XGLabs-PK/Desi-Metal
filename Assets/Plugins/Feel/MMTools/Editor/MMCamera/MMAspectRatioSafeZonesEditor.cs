...
namespace MoreMountains.Tools
{
    ...
    public class MMAspectRatioSafeZonesEditor : Editor
    {
        ...
        /// </summary>
        /// <param name="sceneView"></param>
        static void DrawRatios(SceneView sceneView)
        {
            ...
            foreach (Ratio ratio in safeZones.Ratios)
                if (ratio.DrawRatio)
                {
                    ...
                    var verts = new Vector3[] { ratioTopLeft, ratioTopRight, ratioBottomRight, ratioBottomLeft };
        ...
        /// </summary>
        /// <param name="sceneView"></param>
        static void DrawFrameCenter(SceneView sceneView)
        {

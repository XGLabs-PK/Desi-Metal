...
namespace MoreMountains.Tools
{
    ...
    public class MMMonoBehaviourDrawer : Editor
    {
        ...
        protected virtual void DrawGroup(MMInspectorGroupData groupData)
        {
            ...
            Rect leftBorderRect = new Rect(verticalGroup.xMin + 5, verticalGroup.yMin - 10, 3f,
                verticalGroup.height + 20);
            ...
            groupData.GroupIsOpen = EditorGUILayout.Foldout(groupData.GroupIsOpen, groupData.GroupAttribute.GroupName,
                true, MMMonoBehaviourDrawerStyle.GroupStyle);
            ...
            void DrawChild(int i)
            {
                ...
                EditorGUILayout.PropertyField(groupData.PropertiesList[i],
                    new GUIContent(ObjectNames.NicifyVariableName(groupData.PropertiesList[i].name),
                        groupData.PropertiesList[i].tooltip), true);
            }
        }

...
namespace MoreMountains.Tools
{
    ...
    public class MMTween : MonoBehaviour
    {
        ...
        public static Coroutine MoveTransform(MonoBehaviour mono, Transform targetTransform, Vector3 origin,
            Vector3 destination,
            WaitForSeconds delay, float delayDuration, float duration, MMTweenCurve curve, bool ignoreTimescale = false)
        {
        ...
        public static Coroutine MoveTransform(MonoBehaviour mono, Transform targetTransform, Transform origin,
            ...
            MMTweenCurve curve, bool updatePosition = true, bool updateRotation = true, bool ignoreTimescale = false)
        {
            return mono.StartCoroutine(MoveTransformCo(targetTransform, origin, destination, delay, delayDuration,
        ...
        public static Coroutine RotateTransformAround(MonoBehaviour mono, Transform targetTransform, Transform center,
            ...
            float duration, MMTweenCurve curve, bool ignoreTimescale = false)
        {
        ...
        protected static IEnumerator MoveRectTransformCo(RectTransform targetTransform, Vector3 origin,
            ...
            float delayDuration, float duration, MMTweenCurve curve, bool ignoreTimescale = false)
        {
            if (delayDuration > 0f)
                yield return delay;
            ...
            float delayDuration, float duration, MMTweenCurve curve, bool ignoreTimescale = false)
        {
            ...
            while (timeLeft > 0f)
            {
                targetTransform.transform.position =
                    Tween(duration - timeLeft, 0f, duration, origin, destination, curve);
            ...
            MMTweenCurve curve, bool updatePosition = true, bool updateRotation = true, bool ignoreTimescale = false)
        {
            ...
            {
                if (updatePosition)
                    targetTransform.transform.position = Tween(duration - timeLeft, 0f, duration, origin.position,
                        destination.position, curve);

                if (updateRotation)
                    targetTransform.transform.rotation = Tween(duration - timeLeft, 0f, duration, origin.rotation,
                        destination.rotation, curve);
        ...
        protected static IEnumerator RotateTransformAroundCo(Transform targetTransform, Transform center,
            ...
            MMTweenCurve curve, bool ignoreTimescale = false)
        {
            if (delayDuration > 0f)
                yield return delay;

    ...
    public class MMTouchFollowerJoystick : MMTouchJoystick
    {
        ...
        protected virtual void HandleMovementInterpolation()
        {
            ...
            if (SpringFollowInterpolation)
            {
                ...
                MMMaths.Spring(ref _newBackgroundPosition, _backgroundPositionTarget, ref _springVelocity,
                    SpringDamping, SpringFrequency, InterpolateFollowMovementSpeed, Time.unscaledDeltaTime);
        ...
        protected virtual void CreateInnerRect()
        {
            ...
            if (BackgroundConstraintRectTransform == null)
            {
                ...
                innerRect.transform.SetParent(transform);
        ...
        protected override void OnDrawGizmos()
        {
            ...
            if (!Application.isPlaying)
            {
                if (KnobCanvasGroup != null)
                    ...
                    Handles.DrawWireDisc(transform.position, Vector3.forward, MaxRange);
            }
            else

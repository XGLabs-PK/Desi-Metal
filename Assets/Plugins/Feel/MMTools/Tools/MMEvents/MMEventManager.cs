...
namespace MoreMountains.Tools
{
    ...
    {
        static Dictionary<Type, List<MMEventListenerBase>> _subscribersList;
        ...
        static bool SubscriptionExists(Type type, MMEventListenerBase receiver)
        {

...
namespace MoreMountains.Tools
{
    ...
    {
        static readonly Dictionary<string, MMSpeedTestItem> _speedTests = new Dictionary<string, MMSpeedTestItem>();
        ...
        public static void EndTest(string testID)
        {
            ...
            UnityEngine.Debug.Log("<color=red>MMSpeedTest</color> [Test " + testID + "] test duration : " +
                                  elapsedTime + "s");
        }
    }
}

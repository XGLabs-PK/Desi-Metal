...
namespace MoreMountains.Tools
{
    ...
    public class MMSpawnAroundTester : MonoBehaviour
    {
        ...
        public virtual void Spawn()
        {
            ...
            MMSpawnAround.ApplySpawnAroundProperties(_gameObject, SpawnProperties, transform.position);
        }
        ...
        {
            if (DrawGizmos)
                MMSpawnAround.DrawGizmos(SpawnProperties, transform.position, GizmosQuantity, GizmosSize, Color.gray);
        }
    }
}

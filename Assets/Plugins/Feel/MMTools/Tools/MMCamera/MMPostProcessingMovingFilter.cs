...
namespace MoreMountains.Tools
{
    ...
    public struct MMPostProcessingMovingFilterEvent
    {
        ...
        public static void Trigger(MMTweenType curve, bool active, bool toggle, float duration, int channel = 0,
            bool stop = false)
        {
    ...
    public class MMPostProcessingMovingFilter : MonoBehaviour
    {
        ...
        {
            if (_newPosition != transform.localPosition)
                transform.localPosition = _newPosition;
        ...
        public virtual void OnMMPostProcessingMovingFilterEvent(MMTweenType curve, bool active, bool toggle,
            float duration, int channel = 0, bool stop = false)
        {

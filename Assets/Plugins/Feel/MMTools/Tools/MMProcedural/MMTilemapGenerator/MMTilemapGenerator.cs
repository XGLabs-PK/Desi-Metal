...
namespace MoreMountains.Tools
{
    ...
    public class MMTilemapGenerator : MonoBehaviour
    {
        ...
        protected virtual void GenerateLayer(MMTilemapGeneratorLayer layer)
        {
            ...
            int width = layer.OverrideGridSize ? layer.GridWidth : Random.Range(GridWidth.x, GridWidth.y);
            int height = layer.OverrideGridSize ? layer.GridHeight : Random.Range(GridHeight.x, GridHeight.y);
        ...
        /// </summary>
        /// <param name="layer"></param>
        static async void DelayedCopy(MMTilemapGeneratorLayer layer)
        {

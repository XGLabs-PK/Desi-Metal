...
namespace MoreMountains.Tools
{
    ...
    public class MMGridGeneratorPath : MMGridGenerator
    {
        ...
        /// <returns></returns>
        static int ComputeWidth(System.Random random, int widthChangePercentage, int pathMinWidth, int pathMaxWidth,
            int pathWidth)
        {
        ...
        /// <param name="width"></param>
        /// <returns></returns>
        static int DetermineNextStep(System.Random random, int x, int directionChangeDistance,

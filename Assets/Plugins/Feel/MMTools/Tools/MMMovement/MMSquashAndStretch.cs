...
namespace MoreMountains.Tools
{
    ...
    public class MMSquashAndStretch : MonoBehaviour
    {
        ...
        public float TimescaleTime => Timescale == Timescales.Regular ? Time.time : Time.unscaledTime;
        public float TimescaleDeltaTime => Timescale == Timescales.Regular ? Time.deltaTime : Time.unscaledDeltaTime;

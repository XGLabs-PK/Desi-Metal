...
namespace MoreMountains.Tools
{
    ...
    public static class MMAchievementManager
    {
        ...
        static List<MMAchievement> _achievements;
        static MMAchievement _achievement = null;

        const string _defaultFileName = "Achievements";
        const string _saveFolderName = "MMAchievements/";
        const string _saveFileExtension = ".achievements";
        ...
        static MMAchievement AchievementManagerContains(string searchedID)
        {
        ...
        public static void LoadSavedAchievements()
        {
            ...
            SerializedMMAchievementManager serializedMMAchievementManager =
                (SerializedMMAchievementManager)MMSaveLoadManager.Load(typeof(SerializedMMAchievementManager),
                    _saveFileName + _saveFileExtension, _saveFolderName);
        ...
        /// </summary>
        static void DeterminePath(string specifiedFileName = "")
        {

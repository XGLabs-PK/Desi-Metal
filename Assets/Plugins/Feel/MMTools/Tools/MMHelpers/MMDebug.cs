...
namespace MoreMountains.Tools
{
    ...
    public static class MMDebug
    {
        ...
        static MethodInfo[] _commands;
        // the max length of the log
        static readonly int _logHistoryMaxLength = 256;

#if UNITY_EDITOR
        static bool _debugDrawEnabledSet = false;
#endif
        static bool _debugDrawEnabled = false;
        static bool _debugLogEnabled = false;
        static bool _debugLogEnabledSet = false;
        ...
        public static void DebugLogCommand(string command)
        {
            ...
            var methods = Commands.Where(m => m.Name == commandFirst).ToArray();
        ...
        static void LogCommand(string command, string color)
        {
        ...
        const string _editorPrefsDebugLogs = "DebugLogsEnabled";
        const string _editorPrefsDebugDraws = "DebugDrawsEnabled";
        ...
        const string _debugConsolePrefabPath = "MMDebugOnScreenConsole";
        ...
        public static void InstantiateOnScreenConsole(int fontSize = 25)
        {
            ...
            if (_console == null)
                ...
                _console = (MMDebugOnScreenConsole)Object.FindObjectOfType(typeof(MMDebugOnScreenConsole));
        ...
        /// <param name="arrowHeadLength">Arrow head length.</param>
        /// <param name="arrowHeadAngle">Arrow head angle.</param>
        static void DrawArrowEnd(bool drawGizmos, Vector3 arrowEndPosition, Vector3 direction, Color color,

...
namespace Pathfinding
{
    ...
    public class FadeArea
    {
        ...
        {
            float hermite = Hermite(0, 1, value);
    ...
    public static class EditorGUILayoutx
    {
        ...
        public static int TagField(string label, int value, System.Action editCallback)
        {
            ...
            int newValue = EditorGUILayout.IntPopup(label, value, tagNamesAndEditTagsButton,
                new[]
                {
        ...
        public static LayerMask LayerMaskField(string label, LayerMask selected)
        {
            ...
            {
                var layers = Util.ListPool<string>.Claim();
                ...
                Util.ListPool<string>.Release(ref layers);
            }

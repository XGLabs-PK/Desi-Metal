...
namespace Pathfinding
{
    ...
    public abstract class Path : IPathInternals
    {
        ...
        {
            if (vectorPath != null) Util.ListPool<Vector3>.Release(ref vectorPath);
            if (path != null) Util.ListPool<GraphNode>.Release(ref path);
        ...
        {
            if (ReferenceEquals(o, null)) throw new System.ArgumentNullException("o");

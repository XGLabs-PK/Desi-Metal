            ...
            while (true)
            {
                ...
                if (pd <= numberOfItems)
                {
                    ...
                    if (pd + 1 < numberOfItems && (f1 < swapF || SortGScores && f1 == swapF &&
                            heap[pd + 1].node.G < (swapIndex == parent ? swapItemG : heap[swapIndex].node.G)))
                    {
                        swapF = f1;
                        swapIndex = pd + 1;
                    }
                    ...
                    if (pd + 2 < numberOfItems && (f2 < swapF || SortGScores && f2 == swapF &&
                            heap[pd + 2].node.G < (swapIndex == parent ? swapItemG : heap[swapIndex].node.G)))
                    {
                        swapF = f2;
                        swapIndex = pd + 2;
                    }
                    ...
                    if (pd + 3 < numberOfItems && (f3 < swapF || SortGScores && f3 == swapF &&
                            heap[pd + 3].node.G < (swapIndex == parent ? swapItemG : heap[swapIndex].node.G)))
                        swapIndex = pd + 3;
                }

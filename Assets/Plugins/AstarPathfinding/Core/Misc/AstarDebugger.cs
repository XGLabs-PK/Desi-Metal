...
namespace Pathfinding
{
 ...
 (double)AstarPath.TotalSearchedNodes*10000 / (double)AstarPath.TotalSearchTime;
                        ...
                        if (Util.ListPool<Vector3>.GetSize() > maxVecPool)
                            maxVecPool = Util.ListPool<Vector3>.GetSize();

                        if (Util.ListPool<GraphNode>.GetSize() > maxNodePool)
                            maxNodePool = Util.ListPool<GraphNode>.GetSize();

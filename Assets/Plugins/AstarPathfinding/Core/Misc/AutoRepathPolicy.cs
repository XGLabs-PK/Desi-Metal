    ...
    public class AutoRepathPolicy
    {
        ...
        public virtual bool ShouldRecalculatePath(IAstarAI ai)
        {
            ...
            else
            {
                ...
                float squaredCost = (ai.destination - lastDestination).sqrMagnitude /
        ...
        public void DrawGizmos(IAstarAI ai)
        {
            ...
            {
                float r = Mathf.Sqrt(Mathf.Max((ai.position - lastDestination).sqrMagnitude, ai.radius * ai.radius) /

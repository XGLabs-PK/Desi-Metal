...
namespace Pathfinding
{
    ...
    internal class GraphUpdateProcessor
    {
        ...
        readonly ManualResetEvent asyncGraphUpdatesComplete = new ManualResetEvent(true);

#if !UNITY_WEBGL
        readonly AutoResetEvent graphUpdateAsyncEvent = new AutoResetEvent(false);
        readonly AutoResetEvent exitAsyncThread = new AutoResetEvent(false);
#endif

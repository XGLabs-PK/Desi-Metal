...
namespace Pathfinding
{
    ...
    public partial class AIPath : AIBase, IAstarAI
    {
            ...
            out Quaternion nextRotation)
        {
            ...
            Vector2 forwards = movementPlane.ToPlane(simulatedRotation *
                                                     (orientation == OrientationMode.YAxisForward
                                                         ? Vector3.up
                                                         : Vector3.forward));
            ...
            Vector2 delta2D = lastDeltaPosition =
        ...
        {
            int newGizmoHash = pickNextWaypointDist.GetHashCode() ^ slowdownDistance.GetHashCode() ^

    ...
    public class RaycastModifier : MonoModifier
    {
            ...
            NNConstraint nnConstraint)
        {
            ...
            while (startIndex < points.Count)
            {
                ...
                GraphNode startNode = canBeOriginalNodes && points[startIndex] == (Vector3)p.path[startIndex].position
                    ? p.path[startIndex]
                    : null;
                ...
                while (true)
                {
                    ...
                    GraphNode endNode = canBeOriginalNodes && end == (Vector3)p.path[endIndex].position
                        ? p.path[endIndex]
                        : null;

...
namespace Pathfinding
{
    public class AstarUpdateWindow : EditorWindow
    {
        ...
        public static AstarUpdateWindow Init(Version version, string summary)
        {
            ...
            AstarUpdateWindow window = GetWindow<AstarUpdateWindow>(true, "", true);
        ...
        public void OnDestroy()
        {
            if (version != null && !setReminder)
            {
                ...
                EditorPrefs.SetString("AstarRemindUpdateDate",
                    DateTime.UtcNow.AddDays(1).ToString(System.Globalization.CultureInfo.InvariantCulture));
        ...
        void OnGUI()
        {
            ...
            {
                EditorPrefs.SetString("AstarRemindUpdateDate",
                    DateTime.UtcNow.AddDays(7).ToString(System.Globalization.CultureInfo.InvariantCulture));

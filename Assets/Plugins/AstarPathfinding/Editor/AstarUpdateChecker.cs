...
namespace Pathfinding
{
    ...
    public static class AstarUpdateChecker
    {
        ...
        static bool CheckForUpdates()
        {
            ...
            double minutesUntilUpdate = lastUpdateCheck.AddDays(updateCheckRate).AddMinutes(offsetMinutes)
        ...
        {
            AstarPath script = AstarPath.active != null
                ? AstarPath.active
        ...
        static void ShowUpdateWindowIfRelevant()
        {
            ...
            try
            {
                ...
                Version remindVersion =
                    new System.Version(EditorPrefs.GetString("AstarRemindUpdateVersion", "0.0.0.0"));

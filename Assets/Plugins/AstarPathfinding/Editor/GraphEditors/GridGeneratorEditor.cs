...
namespace Pathfinding
{
    ...
    public class GridGraphEditor : GraphEditor
    {
        ...
        void DrawInspectorMode(GridGraph graph)
        {
            ...
            InspectorGridMode newMode =
                (InspectorGridMode)EditorGUILayout.EnumPopup("Shape", (System.Enum)graph.inspectorGridMode);
        ...
        {
            GUIContent isometricGUIContent = new GUIContent("Isometric Angle",
        ...
        protected virtual void DrawNeighbours(GridGraph graph)
        {
            ...
            GUIContent neighboursGUIContent = new GUIContent("Connections",
        ...
        void DrawCollisionPreview(GraphCollision collision)
        {
            ...
            float nodeSize = (target as GridGraph).nodeSize;
        ...
        public override void OnSceneGUI(NavGraph target)
        {
            ...
            GraphTransform currentTransform =
                graph.transform * Matrix4x4.Scale(new Vector3(graph.width, 1, graph.depth));
